...
- [ ] **Lead Filter Overhaul** — design aprovado (2026-04-13). Busca híbrida cliente/servidor no `LeadList` cobrindo nome/telefone/email/mensagens. Spec: `docs/superpowers/specs/2026-04-13-lead-filter-design.md`.
  - Backend + frontend implementados 2026-04-13. Aguardando QA manual no navegador antes de marcar concluído.
